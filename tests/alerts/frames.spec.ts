...
test.describe('Frames Tests', () => {
  test('Verify content in Frame 1', async ({ page }) => {
    try {
      ...
      logStep('Navigating to Frames page');
      await framesPage.navigate();

      logStep('Verifying Frame 1 content');
      ...
      logStep('Frame 1 content verified successfully');
    } catch (err) {
  ...
  test('Verify content in Frame 2', async ({ page }) => {
    try {
      ...
      logStep('Verifying Frame 2 content');
      ...
      logStep('Frame 2 content verified successfully');
    } catch (err) {
